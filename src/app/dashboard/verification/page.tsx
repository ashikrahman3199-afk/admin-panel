...
export default function VerificationPage() {
    ...
    const [editSpace, setEditSpace] = React.useState<any>(null);
    React.useEffect(() => {
                                ...
                                <TableRow key={space.id} className="hover:bg-white/5 border-none transition-colors group">
                                    ...
                                    <TableCell className="text-right">
                                        <div className="flex justify-end gap-2 items-center">
                                            ...
                                            <Dialog>
                                                <Button variant="ghost" size="icon" className="rounded-full hover:bg-white/10 text-muted-foreground hover:text-primary" onClick={() => openEditDialog(space)}>
